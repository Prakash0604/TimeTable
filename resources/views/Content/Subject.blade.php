                    ...
                    <tbody>
                        ...
                        @forelse ($subjects as $subject)
                            <tr class="">
                                ...
                                <td>
                                    <a class="btn btn-primary editsubject" data-id="{{ $subject->id }}" data-bs-toggle="modal" data-bs-target="#editModal">Edit</a>
                                    <a class="btn btn-danger deletesubject" data-id="{{ $subject->id }}" data-bs-toggle="modal" data-bs-target="#deleteModal"> Delete</a>
                                </td>
                            </tr>
                            @php
                                $n = $n + 1;
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="mb-3">
                                ...
                                <label for="" class="form-label">subject</label>
                                <input type="text" name="edit_subject_name" id="edit_subject_name" class="form-control"
